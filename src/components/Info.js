...
export const projectDetail = [
  'This is my current master thesis. I constructed the transient stochastic collocation method in MATLAB with polynomial chaos and sensitivity analysis invoved, with which, circuit equations can be solved in a decoupled manner and time complexity is 10 times less than Monte Carlo algorithm, but same accuracy achieved. Moreover, new model order reduction and sparse sampling method will be developed in the future.',

  'I designed and developed a homepage and sign up/in components for this web app, as well as integrated the front end built with React.js into Python Django backend. Both web-view and android mobile version of this game are under development. Data that generated by users’ operation on our website will be collected and sent back to database constructed with MySQL.',

  'This is an online project focus on learning Node.js. I developed backend of this task manager app with Node.js. Users can create an account, login/out, add and update their perosnal tasks which information will be stored in cloud MongoDB. ',
